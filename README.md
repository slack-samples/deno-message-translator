...
- **Configurator:** Configure which channels the app can translate messages in. If added to a private channel, please note that you may need to manually add the app to that channel in order for it to work.
